...
public final class Utils {
    ...
    public static ArrayList<EarthquakeModel> fetchEarthquakeData(String requestUrl) {
        ...
        if (!TextUtils.isEmpty(jsonResponse)){
            try {
                ArrayList<EarthquakeModel> earthquake = extractFeatureFromJson(jsonResponse);
                // Return the {@link Event}
                return earthquake;
            }catch (NullPointerException e){
                Log.e(LOG_TAG, "Eath queake extract return null:", e);
            }
        }
    ...
    /**
     * Return an {@link EarthquakeModel} object by parsing out information
     * about the first earthquake from the input earthquakeJSON string.
     */
    private static ArrayList<EarthquakeModel> extractFeatureFromJson(String earthquakeJSON) {
        ArrayList<EarthquakeModel> dataExtract;
        dataExtract = new ArrayList<>();
        ...
        try {
            ...
            if (featureArray.length() > 0) {
                ...
                for (int i = 0; i < featureArray.length(); i++) {
                    ...
                    dataExtract.add(new EarthquakeModel(mag, place, time, url));
                }

                // Create a new {@link EarthquakeModel} object
                if (dataExtract != null) return dataExtract;
