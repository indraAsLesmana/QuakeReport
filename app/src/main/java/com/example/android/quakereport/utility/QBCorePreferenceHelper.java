...
public class QBCorePreferenceHelper {
    ...
    private static QBCorePreferenceHelper instance;

    private SharedPreferences sharedPreferences;

    public static synchronized QBCorePreferenceHelper getInstance() {
        if (instance == null) {
            instance = new QBCorePreferenceHelper();
        }

        return instance;
    }

    private QBCorePreferenceHelper() {
        instance = this;
        sharedPreferences = EarthquakeActivity.getsInstance().
